...
Se configurada, a variável `AUTHENTICATION_API_KEY` requer que as requisições incluam o cabeçalho: ` apikey: XXXXXXXXXX ` Protegendo o serviço contra acessos não autorizados.
